...
class CarController():
  ...
  def update(self, enabled, CS, frame, actuators, \
    ...
    if (frame % 10) == 0:
      idx = (frame//10) % 4
      can_sends.extend(hondacan.create_ui_commands(self.packer, pcm_speed, hud, CS.CP.carFingerprint, False, idx, CS.CP.isPandaBlack, 0))
     ...
     # elif CS.stopped:
      ...
      if (frame % 2) == 0:
        ...
        can_sends.append(hondacan.create_brake_command(self.packer, apply_brake, pump_on,
          pcm_override, pcm_cancel_cmd, hud.fcw, idx, CS.CP.carFingerprint, CS.CP.isPandaBlack, False))
